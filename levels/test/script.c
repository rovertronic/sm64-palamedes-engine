...
const LevelScript level_test_entry[] = {
	...
	AREA(1, test_area_1),
		...
		POINT_LIGHT(40,40,255,4.0f, -782, 255, 635),
		POINT_LIGHT(40,40,255,4.0f, -1872, -2701, 1141),
		OBJECT(MODEL_NONE, 5198, -3626, 1813, 0, 0, 0, 0x00000000, bhvStaticObject),
		LIGHT_PLANE(10,255,10,6.0f, -10595, 1107, -3614, 8657, -3608),
		LIGHT_PLANE(10,255,10,4.0f, 4149, -1091, 10871, 8465, -3626),
		LIGHT_PLANE(10,255,10,12.0f, -807, -7261, 4457, -2395, -2353),
		MARIO_POS(0x01, 0, 0, -140, 0),
		POINT_LIGHT(255,0,255,6.0f, 795, 107, 378),
