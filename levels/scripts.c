...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_YELLOW_COIN,             shitcoin_geo),
    LOAD_MODEL_FROM_GEO(MODEL_STAR,                    retrostar_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TRANSPARENT_STAR,        retrostar_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_YELLOW_COIN_NO_SHADOW,   shitcoin_geo),
